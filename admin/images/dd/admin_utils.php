...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="780" height="100%">
  <tr>
		<td colspan="2" align="center" height="100" valign="middle"><? include("admin_top.php");?></td>
	</tr>
    ...
    <td width="30%" align="left" valign="top" bgcolor="#DADDEC">
      <? include("admin_left.php");?>
    </td>
			<td width="70%" valign="top" bgcolor="#FFFFFF"><?=eval($what);?></td>
		</tr>
	<? }?>
	<tr>
    ...
    <td colspan="2" align="center" height="20" bgcolor="#939FC7"><font color="#FFFFFF" size="1" face="Verdana">Copyright 
      &copy; 
      <?=date('Y');?>
      www.tutor.com - All Rights Reserved</font></td>
	</tr>
	</table>
	</body>
	</html>
...
//-->
	...
	<table width="100%" align="center" border="0" cellspacing="0" cellpadding="4">
	  <tr>
		<td width="15%" align="left"><? if($_POST[pageNo]!=1){ ?>
				<a href="javascript:prevPage(<?=$_POST[pageNo] ?>);" onmouseout="javascript:window.status='Done';" onmousemove="javascript:window.status='Go to Previous Page';"><font size="3">&#171;</font> Prev</a>
			<? }else{ ?>
		...
		?></td>
		<td width="15%" align="right"><? if($_POST[pageNo] != $noOfPages) { ?>
				<a href="javascript:nextPage(<?=$_POST[pageNo] ?>)" onmouseout="javascript:window.status='Done';" onmousemove="javascript:window.status='Go to Next Page';">Next <font size="3">&#187;</font></a>
			<? }else{ ?>
	  ...
	  <tr>
		...
		<? for($i=1;$i<=$noOfPages;$i++){?>
			<option value="<?=$i;?>" <?=($_POST[pageNo]==$i)?"selected":"";?>><?=$i;?></option>
		<? }?>
		</select></td>	
	  </tr>
	  <? } ?>
