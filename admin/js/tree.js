...
function createTree(arrName, startNode, openNode) {
	...
	if (nodes.length > 0) {
		...
		if (openNode != 0 || openNode != null || startNode !=0 ) setOpenNodes(openNode);
		...
		} else document.write("<img src=\"img/base.gif\" align=\"absbottom\" alt=\"\" />ADMIN MENU<br />");
	...
	for (var i = 0; i < nodes.length; i++) {
		...
		if (nodeValues[1] == parentNode) {
			...
			if (hcn) {
				...
				//document.write("<img id=\"icon" + nodeValues[1] + "\" src=\"img/folderopen")
				document.write(".gif\" align=\"absbottom\" alt=\"Folder\" />");
			}else
			document.write("<img id=\"icon" + nodeValues[1] + "\" src=\"img/page.gif\" align=\"absbottom\" alt=\"Page\" />");
...
/*	   {
		if (bottom==1) theJoin.src = icons[5].src;
		else theJoin.src = icons[2].src;
		theIcon.src = icons[5].src;
		theDiv.style.display = '';
	}*/
